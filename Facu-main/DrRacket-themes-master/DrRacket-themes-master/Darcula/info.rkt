...
(define base09 #(114 152 222))
(define base0A #(160 110 59))
(define base0B #(104 147 77))
(define base0C #(192 87 152))
(define base0D #(155 180 193))
(define base0E #(214 112 10))
...
(define framework:color-schemes
  `(#hash((name . "Darcula")
	   ...
	   ((drracket:syncheck:matching-identifiers            ,base03)
            ...
            (framework:syntax-color:scheme:comment             ,base04)
